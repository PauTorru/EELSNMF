...
class Decomposition(
    ...
    def decomposition(
        ...
        **kwargs : passed to decomposition_method
        ...
        self.analysis_description["decomposition"]["use_cupy"] = (
            use_cupy and CUPY_AVAILABLE
        )
        ...
        self.analysis_description["decomposition"]["Fix_W"] = W_fixed_bool is not None
    ...
    def apply_fix_W(self):
        """ """
        if self.W_fixed_bool is not None:
